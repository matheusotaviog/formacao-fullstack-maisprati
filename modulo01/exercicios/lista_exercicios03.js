...
arrayMusicas.forEach((musica, index) => {
    duracaoTotalMusicas += musica.duracaoSegudos
})
...
class ListaLigadaSimples {
    ...
    remover(tarefa) {
        console.log('\nRemovendo tarefa: ', tarefa)
        if(this.comeco === null) {
            console.log('Lista vazia. Nenhuma tarefa para remover.')
            return
        }

        if(this.comeco.valor === tarefa) {
